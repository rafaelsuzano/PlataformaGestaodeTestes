...
path = "backend/src/main/kotlin/br/com/suzanoit/qa/modules/api_testing/presentation"

controllers_content = """package br.com.suzanoit.qa.modules.api_testing.presentation
...
with open(os.path.join(path, "ApiTestingControllers.kt"), "w") as f:
    f.write(controllers_content)

print("Created ApiTestingControllers.kt")
